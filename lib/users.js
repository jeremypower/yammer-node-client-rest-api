...
YammerUsersAPI.prototype.get_token = function(consumerKey, id, callback) {
    this.doGet(this.baseUrl + '/oauth/tokens.json', { "consumer_key": consumerKey, "user_id": id }, callback);    
};
